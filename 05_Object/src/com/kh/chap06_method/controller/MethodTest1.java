package com.kh.chap06_method.controller; //기능을 담당하는 메서드들을 정리, model.vo는 틀
...
public class MethodTest1 {
	 ...
	 * }
	 * 
	 * 메서드를 정의한 후 항상 원하는만큼 호출해서 사용할 수 있음.
	 */
	...
	public int method2() {
		...
		//재사용할 필요성이 없는 코드에는 굳이 변수를 안쓰는게 좋음
	}
	...
	public void method3(int num1, int num2) {
		...
		//num1 과 num2의 값을 비교하여 결과를 출력하는 메서드
		//최소값 : xx
		//최대값 : xx
