...
public class StreamTest {
	...
	public static void main(String[] args) {
		...
		// forEach 반복문을 통해 배열 요소에 하나씩 접근, 그 안에 담긴 값을 모두 더하고 싶음.
		int sum = 0;
		String test = "지역변수";
		...
		/*
		 * 람다식에서 지역변수를 사용하려면 그 값이 final(상수)이거나 
		 * 사실상 값이 할당된 후 바뀌지 않아서 final처럼 사용되는 경우에만 사용 가능하다.
		 * 
...
//		}
		...
		pList.add(new Product("갤럭시 z플립4", 1500000, 10, "삼성"));
		pList.add(new Product("아이폰14", 1300000, 20, "애플"));
		pList.add(new Product("갤럭시탭 S8", 700000, 50, "삼성"));
