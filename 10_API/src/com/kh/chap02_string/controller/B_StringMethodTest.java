...
public class B_StringMethodTest {
	...
	public void method() {
		...
		//2. 문자열.concat(String str) : String -> 12:32 수업 참고
		...
		System.out.println(str1.substring(0,5)); // 잘라오려는 문자열의 한칸 뒤까지 작성 -> 0 <= 인덱스범위 < 5
		
		//5. 문자열.replace(char old, char new) : String
		//	 => 현재 문자열에서 old문자를 new 문자로 대체(replace)하고 변환한 문자열 리턴
		String str3 = str1.replace('l', 'a'); // -> 선언만 하고 값을 저장 안시키면 안바뀜(String str3 = )
		System.out.println("str3 : " + str3);
		
		//6. 문자열.trim() : String
		//	 => 문자열의 앞 뒤 공백을 제거한 문자열 리턴
		String str4 = "                        J A V A              ";
		System.out.println("trim() : " + str4.trim()); // 앞뒤만 제거, 사이사이는 그대로
