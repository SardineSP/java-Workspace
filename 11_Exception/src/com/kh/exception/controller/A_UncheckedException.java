...
public class A_UncheckedException { //체크를 안해도 되는 오류
	 ...
	 * - ArrayIndexOutOfBoundsException : 배열의 부적절한 인덱스로 접근할 때 발생하는 예외 : 6, -1
	 * - NegativeArraySizeException : 배열의 크기를 음수로 지정할 경우 발생하는 예외 : new int[-5];
...
//		System.out.println("프로그램 종료.");
	...
	public void method3() {
		...
		int size = Integer.parseInt(sc.nextLine()); // 어떤값을 받아오든 int 자료형에 대입시킴
