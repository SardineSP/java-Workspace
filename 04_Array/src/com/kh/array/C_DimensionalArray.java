...
public class C_DimensionalArray {
	...
	public void method1() {
		...
		System.out.println(arr); //[[I@7637f22 -> [[ : 이차원 배열이라는 뜻
		System.out.println(arr[0]); //[I@3830f1c0 -> [ : 일차원 배열이라는 뜻
	...
	public void method7() {
		//int형 이차원 배열을 만들어 0번행 국어점수를 3개 입력받고,
		//1번행에는 영어점수를 3개 입력받은 후 각각 반복문을 활용해서 출력
		//입력 예시 : xx점수를 입력하세요 :
		//출력 예시 : xx점수 : xx xx xx
