...
public class E_Comparison {
	...
	public void method1() {
		...
		System.out.println("a > b : " + (a> b)); //대소비교연산자는 괄호로 묶기!
		System.out.println("a <= b : " + (a <= b));
		
		boolean result1 = (a == b); //boolean 만의 특징인가? 아니면 비교연산자는 이렇게 넣어도 되는가?
		...
		//산술연산 + 비교연산
		System.out.println(a - b < 0); //우선순위 상 괄호는 필요없음
	...
	public void method2() { // 거의 대부분 사용자가 입력한 값을 대소비교
