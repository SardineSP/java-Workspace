...
public class B_InDecrease {
	...
	public void method1() {
		...
		System.out.println("2회 수행 후 결과 : " + num2++); //11 출력 후 1 증가 12담김
	...
	public void method3() {
		int num1 = 20;
		int result1 = num1++ *3; // 21, 60? 후위연산은 제일 나중?
		                         // result1 = 20 * 3 연산 후 num1 = num1 + 1
		System.out.println("num1 : " + num1);
		System.out.println("result1 : " + result1);
		
		int num2 = 20;
		int result2 = ++num2 * 3; // num2 = nu2 + 1 연산 후 result2 = 21 * 3
