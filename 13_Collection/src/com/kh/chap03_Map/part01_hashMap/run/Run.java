...
public class Run {
	...
	public static void main(String[] args) {
		...
		/*
		 * 계층구조를 보면 List나 Set계열은 Collection을 구현한 클래스 => 데이터를 추가할 때 add메서드
		...
		// iterator()는 List와 Set계열에서만 쓰는 메서드이기 때문에 바로 사용 불가.
		...
		for(Entry<String, Snack> entry : hm.entrySet()) { // 이런식으로 아래것들을 줄일수도...
		...
		Iterator<Entry<String, Snack>> itEntry = hm.entrySet().iterator(); // 이런식으로 줄이기도 가능
